...
| selectedTextStyle        | This value is used to set a style for Text inside SideBarItem when it is selected.                                            | :white_check_mark: | <pre>TextStyle(<br>    color: Color(0xffC5CAE9),<br>)</pre> |
| unselectedTextStyle      | This value is used to set a style for Text inside SideBarItem when it is unselected.                                          | :white_check_mark: | <pre>TextStyle(<br>    color: Color(0xff448AFF),<br>)</pre> |
| borderRadius             | This value is used when [enableFloating] is set to true and is used to set a radius at the edges of the SideBar.              | :white_check_mark: | <pre>BorderRadius.all(Radius.circular(6))</pre>             |
| sideBarCurve             | This value is used to indicate an animation curve for all SideBar animations.                                                 | :white_check_mark: | <pre>Curves.ease</pre>                                      |
| sideBarAnimationDuration | This value is used to indicate a duration for all SideBar animations.                                                         | :white_check_mark: | <pre>Duration(milliseconds: 300)</pre>                      |
| floatingPadding          | This value is used to determine the space surrounding the SideBar and is usable when [enableFloating] is set to true.         | :white_check_mark: | <pre>EdgeInsets.all(8)</pre>                                |
